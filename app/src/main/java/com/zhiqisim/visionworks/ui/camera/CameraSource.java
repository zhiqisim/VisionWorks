...
public class CameraSource {
    ...
    public CameraSource start() throws IOException {
        synchronized (mCameraLock) {
            ...
            // Fall back to use SurfaceView if version of android is
            // lower than Honeycomb (11)
    ...
    public void stop() {
        synchronized (mCameraLock) {
            ...
            if (mCamera != null) {
                ...
                try {
                    // Use SurfaceHolder if Android version is lower than Honeycomb
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
